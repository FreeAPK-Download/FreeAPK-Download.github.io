...
const Cart = () => {
  const cartItems = [
    { id: 1, restaurant: "Italian Bistro", item: "Margherita Pizza", price: 18, quantity: 2, image: "🍕" },
    { id: 2, restaurant: "Sushi Palace", item: "California Roll", price: 22, quantity: 1, image: "🍱" },
    { id: 3, restaurant: "Burger House", item: "Classic Burger", price: 15, quantity: 1, image: "🍔" },
  ];
